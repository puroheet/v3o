    ...
    <div className="w-full flex flex-col items-center gap-8 p-8 bg-gray-800/50 rounded-lg border border-gray-700 shadow-2xl">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        <button
          ...
          disabled={!canExtend}
          title={
            canExtend ? 'Extend this video' : 'Only 720p videos can be extended.'
          }
          className="flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-colors disabled:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed">
